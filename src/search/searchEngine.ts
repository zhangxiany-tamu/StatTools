...
const CURATED_ALIASES: Record<string, string[]> = {
  ...
  "reshape wide to long": ["pivot_longer", "pivot_wider"],
  "reshape long to wide": ["pivot_wider", "pivot_longer"],
...
const CANONICAL_RESULTS: Record<string, string[]> = {
  ...
  "compare nested models": ["stats::anova"],
  ...
  "reshape wide to long": ["tidyr::pivot_longer", "tidyr::pivot_wider"],
  "reshape wide to long pivot": ["tidyr::pivot_longer", "tidyr::pivot_wider"],
  ...
  "read csv": ["utils::read.csv", "readr::read_csv"],
  ...
  "box plot": ["ggplot2::geom_boxplot", "ggplot2::ggplot"],
  "heatmap": ["ggplot2::geom_tile", "ggplot2::ggplot"],
  ...
  "train test split": ["caret::createDataPartition"],
